...
[JsonDerivedType(typeof(FlatGroupGame), "group")]
[JsonDerivedType(typeof(FlatKoGame), "ko")]
public abstract record class FlatGame
{
	/// <summary>
	...
	/// <summary>FK into <see cref="FlatCompetition.Rounds"/>. Stage is implied via FlatRound.StageId.</summary>
	...
	/// </summary>
	public FlatResult? Result { get; set; }
...
/// the group letter via FlatCompetition.GroupAssignments).
/// </summary>
public sealed record class FlatGroupGame : FlatGame
{
...
/// </summary>
public sealed record class FlatKoGame : FlatGame
{
