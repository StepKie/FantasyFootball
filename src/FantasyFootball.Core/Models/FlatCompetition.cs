...
/// <summary>
/// Flat competition record (new model). Stages, Rounds, GroupAssignments,
/// and Games live as sibling arrays — no parent-child navigation chain.
/// Lookups across them go through Ids (FlatGame.RoundId → FlatRound,
/// FlatRound.StageId → FlatStage, etc.) or extension methods on
/// FlatCompetition.
///
/// Self-contained: a FlatCompetition can be serialized in isolation.
/// Bulk simulation produces N independent FlatCompetitions, each fully
...
/// </summary>
public sealed class FlatCompetition
{
	/// <summary>
	...
	/// <see cref="FlatCompetitionExtensions.AllTeamIds"/>.
	/// </summary>
