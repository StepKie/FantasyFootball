...
/// (unsimulated) <see cref="Competition"/> ready for sim — Stages,
...
/// </summary>
public static class CompetitionDefinitionLoader
{
	public static Competition Load(string json)
	{
	...
	public static Competition LoadFromStream(Stream stream)
	{
	...
	static Competition MaterializeCompetition(RawDefinition raw)
	{
		...
		foreach (var g in raw.Games.OfType<GroupGame>())
		{
	...
	/// Competition by <see cref="MaterializeCompetition"/>.
	/// </summary>
