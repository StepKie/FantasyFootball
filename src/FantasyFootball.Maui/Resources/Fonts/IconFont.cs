namespace FantasyFootball.Resources.Fonts;

/// <summary>
/// Generated by IconFont2Code: https://andreinitescu.github.io/IconFont2Code
/// Underlying icon font: https://github.com/google/material-design-icons/blob/master/font/MaterialIconsOutlined-Regular.otf
/// The ids can be queried via https://fonts.google.com/icons (see code point on the right hand side, without the "\u" unicode specifier)
/// You can use these values by binding them to a ViewModel property, and then accessing them in XAML
/// <list type="bullet">
/// <item>Using any element that supports FontFamily attribute, like a Text property of a Label: &lt;Label Text="{Binding Add_a_photo}" FontFamily="Material" FontSize="50" TextColor="Orange"/&gt;</item>
/// <item>Using a <see cref="FontImageSource"/>: &lt;FontImageSource FontFamily="Material" Glyph="{Binding Add_a_photo}" FontSize="50" TextColor="Orange"/&gt;</item>
/// </list>
/// </summary>
public static class IconFont
{
	// if you want to use these in a ResourceDictionary, these strings need to be escaped like this: "\ue87c" -> "&#xe87c;"
	// i.e. add them like this: <x:String x:Key="IconFace">&#xe87c;</x:String>
